              ...
              <div class="card-body">
                <div class="row gutters-5">
                  ...
                  <div class="col-md-3 ml-auto">
                    <label for="update_tracking_code"
                      >Tracking Code (optional)</label
                    >
                    <input
                      type="text"
                      class="form-control"
                      id="update_tracking_code"
                      value="<?= !empty($order['tracking_code']) ? $order['tracking_code'] : ''; ?>"
                    />
                  </div>
                </div>
                <div class="mb-3">
                ...
                <div class="row gutters-5 mb-3">
                  <div class="col text-center text-md-left">
                    <address>
                      ...
                      <?=$order['created_at'];?>
                      <br />
                      <?= '+' . $customer['country_code'] . '-' . $customer['cust_phone']?><br />
                      <?=$order['order_addr']?><br />
                      
                    </address>
                  </div>
                  <div class="col-md-4 ml-aut0">
                    <table>
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td class="text-right">Rs: <?=$order['order_total'];?></td>
                        </tr>
                        <tr>
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr ">
                          ...
                          <td>
                            <a
                              href="<?= base_url('product/' . $d['prod_id']) ?>"
                              target="_blank"
                              ><img
                                height="50"
                                src="<?= base_url('public/uploads/products/' . $d['prod_img']) ?>"
                            /></a>
                          </td>
                          <td>
                            <strong
                ...
                <div class="clearfix float-right">
                  ...
                  <div class="text-right no-print">
                    <a
                      href="https://demo.activeitzone.com/ecommerce/invoice/49"
                      type="button"
