                        ...
                        <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                            <div class="card">
                                ...
                                <div class="px-4 py-3 py-lg-4">
                                    <div class="">
                                        <form  action="<?=base_url('seller/verify')?>" method="post">
                                            <?= csrf_field(); ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="<?=base_url('seller/registration')?>">Register Now</a>
                                    </div>
                                    <div class="text-center">
                                        <a href="<?=base_url('customer/login')?>">Login as a customer</a>
                                    </div>
                                </div>
                            </div>
                        </div>
