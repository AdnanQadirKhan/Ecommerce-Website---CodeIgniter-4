                            ...
                            <div class="bg-white shadow-sm rounded mb-3">
                                ...
                                <div class="p-3">
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <a class="text-reset fs-14 fw-600" href="<?= base_url('categories') ?>">
                                        ...
                                        <?php foreach ($categories as $categ) : ?>
                                            <li class="mb-2">
                                                <a class="text-reset fs-14 fw-600" href="<?= base_url('category/products/' . $categ['cat_id']) ?>">
                                                    <i class="las la-angle-left"></i>
                                                    <?= $categ['cat_name'] ?>
                                                </a>
                                            </li>
                                    ...
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                        <div class="position-relative">
                                            ...
                                            <div class="absolute-top-right aiz-p-hov-icon">
                                                ...
                                                <a href="javascript:void(0)" onclick="showAddToCartModal(2)" data-toggle="tooltip" data-title="Add to cart" data-placement="left" tabindex="0">
